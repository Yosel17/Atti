...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindFastingFormRepository(
        impl: FastingFormRepositoryImpl
    ): FastingFormRepository

    @Binds
    @Singleton
    abstract fun bindTreatmentFormRepository(
        impl: TreatmentFormRepositoryImpl
    ): TreatmentFormRepository

    @Binds
    @Singleton
    abstract fun bindPreAnestheticTestFormRepository(
        impl: PreAnestheticTestFormRepositoryImpl
    ): PreAnestheticTestFormRepository

    @Binds
    @Singleton
    abstract fun bindPrescriptionFormRepository(
        impl: PrescriptionFormRepositoryImpl
    ): PrescriptionFormRepository

    @Binds
    @Singleton
    abstract fun bindObservationFormRepository(
        impl: ObservationFormRepositoryImpl
