...
@Entity(
    ...
    indices = [
        Index(value = ["consultation_id"], name = "idx_shift_medications_consultation_id"),
        Index(value = ["product_id"], name = "idx_shift_medications_product_id"),
        Index(value = ["service_id"], name = "idx_shift_medications_service_id"),
        Index(value = ["status"], name = "idx_shift_medications_status")
    ]
)
data class ShiftMedicationEntity(
    @PrimaryKey
    @ColumnInfo(name = "id")
    val id: String,
